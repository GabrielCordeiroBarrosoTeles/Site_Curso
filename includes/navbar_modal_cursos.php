                ...
                if (mysqli_num_rows($query_run) > 0) {
                    foreach ($query_run as $estoque) {
                        ...
                        if (!in_array($estoque['categoria'], $funcoes)) {
                            ...
                            <li class="nav-item">
                                <p class="p">
                                    <a class="link" style="text-decoration: none;" href="cursos.php?id=<?= $estoque['id']; ?>">
                                        <?= $estoque['categoria']; ?>
                                    </a>
                                </p>
                            </li>
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-8">
                            <form class="p-lg-5 col-12 row g-3" action="receber_login.php" method="post">
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-brand text-light" style="background-color: #2222ff;border: #2222ff">Logar</button>
                                </div>
                            </form>
                        </div>
                    </div>
