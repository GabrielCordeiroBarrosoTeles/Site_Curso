<?php
    ...
    // Prepara a query para selecionar apenas as aulas do módulo selecionado
    $query = "SELECT aula.*, modulo.titulo AS titulo_modulo 
              FROM aula 
              JOIN modulo ON aula.id_modulo = modulo.id 
              WHERE aula.id_modulo = ? 
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Lista de Aulas do Módulo <?= htmlspecialchars($modulo_id); ?></h4>
                    </div>
                    <div class="card-body">
                                ...
                                if (mysqli_num_rows($query_run) > 0) {
                                    while ($aula = mysqli_fetch_assoc($query_run)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?= htmlspecialchars($aula['titulo_modulo']); ?></td>
                                            ...
                                            <td><?= htmlspecialchars($aula['duracao']); ?></td>
                                        </tr>
                                        <?php
                                    }
                                } else {
