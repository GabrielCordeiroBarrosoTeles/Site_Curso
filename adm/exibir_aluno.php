                        ...
                        <table class="table table-bordered table-striped" id="example" style="align-items: center;text-align: center;">
                            <thead style="align-items: center;text-align: center;">
                                <tr style="align-items: center;text-align: center;">
                                    ...
                                    <?php if (isset($_SESSION['tipo_usuario']) && ($_SESSION['tipo_usuario'] === 'adm' || $_SESSION['tipo_usuario'] === 'operador')): ?>
                                        <th>Gerar NF</th>
                                    <?php endif; ?>
                                    <th>Visualizar</th>
                                    <th>Editar</th>
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $student)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <?php if (isset($_SESSION['tipo_usuario']) && ($_SESSION['tipo_usuario'] === 'adm' || $_SESSION['tipo_usuario'] === 'operador')): ?>
                                                    <td>
                                                    <a href="gerar_nota_fiscal.php?id=<?= $student['aluno_id']; ?>" class="btn btn-warning btn-sm">
                                                        Gerar NF
                                                ...
                                                <td>
                                                    <a href="cliente-view.php?id=<?= $student['aluno_id']; ?>" class="btn btn-primary btn-sm">
                                                        Vizualizar
                                                ...
                                                <td> 
                                                    <a href="cliente-edit.php?id=<?= $student['aluno_id']; ?>" class="btn btn-success btn-sm">
                                                        Editar
                                                ...
                                                <td> 
                                                    <form action="code.php" method="POST" class="d-inline">
                                                        <button type="submit" name="delete_cliente" value="<?=$student['aluno_id'];?>" class="btn btn-danger btn-sm">
                                                            Deletar
